...
#Extrair Pacote purebasic no diretorio ~/Downloads
...
#Dependencia para executar Purebasic 32bits em ambiente 64
sudo apt-get install ia32-libs
sudo apt-get install gcc-multilib libc6-i386 libc6-dev-i386
sudo apt-get install libgtk2.0-dev libsdl1.2-dev

#Atalho purebasic_600 x64
echo "[Desktop Entry]
    Type=Application
    Icon=/home/abrahao/Downloads/purebasic_600/logo.png
    Name=Purebasic v6.0
    Comment=Developer Utility
    Exec=/home/abrahao/Downloads/purebasic_600/compilers/purebasic
    Path=/home/abrahao/Downloads/purebasic_600/compilers
    StartupNotify=false
    Terminal=false
